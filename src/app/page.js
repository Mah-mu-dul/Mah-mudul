...
export default function Home() {
  ...
  return (
    <div className='bg-[#100e17] text-white max-w-[1500px] mx-auto '>
      <Head>
      ...
      <main className="lg:px-30 md:px-20 px-5">
        <section id="Home" className="lg:mt-16 pt-10 flex items-center justify-center text-white text-4xl">
          <Intro />
        </section>
        ...
        <section id="Contact" className="min-h-screen flex items-center justify-center text-white text-4xl">
          <Contact />
        </section>
      </main>
    </div>
